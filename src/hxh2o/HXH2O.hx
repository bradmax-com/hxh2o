...
<set name="H2O" value="/root/h2o" />
<set name="SSL" value="/root/openssl" />
...
<files id="haxe">
    ...
    <compilerflag value="-I${H2O}/deps/picotls/include"/>
    <compilerflag value="-I${H2O}/deps/quicly/include"/>
    <compilerflag value="-I${SSL}/include"/>
    <compilerflag value="-I${SSL}"/>
    
    <compilerflag value="-I./include"/>
    <compilerflag value="-Iinclude"/>
    <file name="${HXH2O}/cpp/Srv.cpp"/>
</files>
...
class HXH2O {
	...
	public static function hxh2o_bind(host:String, port:Int):Dynamic
		return null;
}
