...
HXCPP_EXTERN_CLASS_ATTRIBUTES cpp::Pointer<HXredisReply> _redisCommandArgv(cpp::Pointer<redisContext> c, int len, Array<ConstCharStar> strArr, Array<int> lenArr);
